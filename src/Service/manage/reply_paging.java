...
public class reply_paging implements Action {
	...
	public void command(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<PostVo> list = ManageDAO.getInstance().getListWithPagingR_Manage(cri,query_keyword,query_type,query_term,b_idx);
		...
		int count = ManageDAO.getInstance().getCountR_Manage(query_keyword,b_idx);
