        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 text-gray-800 mb-15">ユーザー一覧</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><a href="/admin/main.do">Main</a> / ユーザー一覧</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <c:forEach var="list" items="${list }">
                                        <tr onclick="location.href='/admin/user_detail.do?idx=${list.idx}'" style="cursor: pointer;">
                                            <th>${list.user_num}</th>
                                            <th>${list.user_id }</th>
                                            <th>${list.nickname }</th>
                                            <th>${list.email }</th>
                                            <c:if test="${list.role eq 0}"><th>ユーザー</th></c:if>
                                            <c:if test="${list.role eq 1}"><th>管理者</th></c:if>
