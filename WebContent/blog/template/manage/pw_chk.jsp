		...
		<div class="container">
			<div class="row posts-entry tab-content" id="myTabContent">
				...
				<div class="col-lg-8 tab-pane fade show active ml-45" id="home" role="tabpanel" aria-labelledby="home-tab">
					...
					<form method="post" action="/manage/pw_chkAction.do">
						<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between pr-50 pl-50" style="padding-top: 23px !important;border: 1px solid rgba(0, 0, 0, 0.125);">
							<input type="password" class="form-control" name="pw" id="pw" placeholder="password" required="" style="background-color: white !important;">
